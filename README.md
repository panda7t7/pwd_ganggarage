...
- Vehicle Modifiers - These can be used for making sure the vehicles comes out exactly how you want it to
	- `CustomName = "Rumpo XL",` this will show a custom override name for your vehicles so you don't need to add them to your vehicles.lua
...
Locations = {
	{	zoneEnable = true, -- disable if you want to hide this temporarily
		gang = "ballas", -- set this to required job grade
		garage = {
			...
			list = {  -- The list of cars that will spawn
				["rumpo"] = {
					...
					trunkItems = {
						{ name = "weapon_pistol", amount = 2, info = {}, type = "item", slot = 1, },
						{ name = "weapon_bat", amount = 10, info = {}, type = "item", slot = 2, },
					},
				},
